...
/*Esta variable está declarada aquí e inicializada en otro sitio, que es visible desde aquí. esto es común hacerlo cuando queremos que una variable que tenemos en una libería se use en muchos sitios de forma común*/
extern int MAX;
